...
function takeANumber(katzDeli, newPerson) {
  ...
  var lineCount = katzDeli.push(newPerson);
  //var lineCount = (katzDeli.indexOf(newPerson) + 1);
  
  
//  if (katzDeli.length > 0) {
    
     return "Welcome, " + newPerson + ". You are number " + lineCount + " in line."
//  } else {  
 //    return "Welcome, " + newPerson + ". You are number " + lineCount + " in line."
 // }
...
function currentLine(katzDeliLine){
 ...
 var intCount = 0;
   ...
   if (katzDeliLine.length <= 0){
      ...
      katzDeliLine.forEach(myFunction);
      katzDeliLine.sort();
      katzDeliLine.reverse();
